...
rsync --safe-links --exclude 'data' --exclude 'dnase' --exclude 'scATAC'  --max-size 10m -rv /g/furlong/project/28_B_DNASE/analysis/evolutionary_analyses/INSIGHT/ ~/Harnett/Atac_evo/
